...
for (const source of ['../lib/binsentry-reading-time.ts', '../../supabase/functions/_shared/binsentry-reading-time.ts']) {
const mod={exports:{}};new Function('exports',ts.transpileModule(fs.readFileSync(path.join(__dirname,source),'utf8'),{compilerOptions:{module:ts.ModuleKind.CommonJS,target:ts.ScriptTarget.ES2022}}).outputText)(mod.exports);
