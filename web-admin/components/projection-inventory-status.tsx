...
export function ProjectionInventoryStatus({ readings, problems, warnings, simulated, rows, orders }: {
  rows: FeedProjectionReportRow[]; orders: FeedProjectionOnOrderRow[];
