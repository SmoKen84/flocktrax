...
comment on function public.sync_derived_placement_issues(uuid[]) is
  'Auto-manages placement issues for severe early mortality and hatchery-quality incidents using app_settings thresholds and a master mortality_autowarn switch.';
